...
theory Types imports "HOL-IMP.Star" Complex_Main begin
...
"taval a1 s (Rv r) \<Longrightarrow> taval a2 s (Iv i)
 \<Longrightarrow> taval (Plus a1 a2) s (Rv(r+i))" |
"taval a1 s (Iv i) \<Longrightarrow> taval a2 s (Rv r)
 \<Longrightarrow> taval (Plus a1 a2) s (Rv(i+r))"
...
"taval a1 s (Rv r) \<Longrightarrow> taval a2 s (Iv i) \<Longrightarrow> tbval (Less a1 a2) s (r < i)" |
"taval a1 s (Iv i) \<Longrightarrow> taval a2 s (Rv r) \<Longrightarrow> tbval (Less a1 a2) s (i < r)"
...
Less_ty: "\<Gamma> \<turnstile> a1 : \<tau>\<^sub>1 \<Longrightarrow> \<Gamma> \<turnstile> a2 : \<tau>\<^sub>2 \<Longrightarrow> \<Gamma> \<turnstile> Less a1 a2"
